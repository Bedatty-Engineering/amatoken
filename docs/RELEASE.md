...
[`Bedatty-Engineering/modules-hub@1.4.1`](https://github.com/Bedatty-Engineering/modules-hub).
...
| `.github/workflows/release.yml` | Caller — invokes `modules-hub@1.4.1` on push to `main` / `dev`. |
...
2. `release.yml` triggers, calls `modules-hub@1.4.1`:
